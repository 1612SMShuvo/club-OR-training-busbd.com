...
<div class="container">
	<br><br>
	<center><div class="text"><h2>সহ-প্রকল্পের বিবরণী</h2></div></center>
	<br><br>
	<form action="{{URL::to('update_currentstructure/'.$info->id)}}" method="POST">
	    ...
	    <div class="form-group col-lg-12 col-sm-12 col-md-12">
	   		...
	   		<input type="text" class="form-control" id="inputEmail4" name="address" value="{{($info->address)}}" placeholder="চলমান কাঠামোর ঠিকানা" readonly="">
	   	</div>
	  	<div class="form-group col-lg-12 col-sm-12 col-md-12">
	   		<label for="inputEmail4">চলমান প্রকল্পের বিবরনী</label>
	   		<textarea class="form-control" id="exampleFormControlTextarea4" rows="5" name="description" placeholder="সংস্থার চলমান কাঠামোর বিবরনী" readonly="">{{($info->description)}}</textarea>
	    </div>
	  	<br><br>
	</form>
	<br><br>
