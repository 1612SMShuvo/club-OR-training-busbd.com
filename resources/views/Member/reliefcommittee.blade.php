    ...
    <div class="shop-detail-box-main">
        <div class="container">
        	...
        	<hr>
	            @php $i=0; @endphp
	            	<center>
	            		<h2>ত্রান উপদেষ্টা কমিটির সদস্য মন্ডলী</h2>
	            	</center>
	            	<br>
			    @if($value>=1)
	        <table class="table">
			    	...
			    	@foreach($committees as $data)
			      	<tr>
				        <th scope="row">@php echo $i=$i+1; @endphp</th>
						    ...
						    <td>{{($data->rank)}}</td> 
				        <td>
				        	<a href="{{URL::to('viewreliefcommittee/'.$data->id)}}"><img style="height: 35px; width: 35px; padding-right: 2px;" src="{{asset('frontendhome/images/view.PNG')}}"></a>
					    </td>
				    </tr>
				    @endforeach
				</tbody>
