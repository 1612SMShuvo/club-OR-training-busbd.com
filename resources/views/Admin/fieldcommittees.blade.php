    ...
    <div class="shop-detail-box-main">
        <div class="container">
			<div class="form-group">
				<center>
						<div class="col-lg-12 col-md-12 col-sm-12">
							<form class="form-group" action="{{URL::to('addfieldcommittees')}}" method="GET">
								@csrf
								<div class="row">
									<div class="col-md-10">
			...
			<div class="row col-lg-12 col-md-12">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<form class="form-inline form-group" action="{{URL::to('searchfieldcommittee')}}" method="GET">
						@csrf
			...
			<br>
			<center>
	            <h2>মাঠ কর্যক্রম সাব-কমিটি সদস্য মন্ডলী</h2>
	        </center>
	        @php $i=0; @endphp
	        <table class="table">
			    	...
			    	@foreach($committees as $data)
			      	<tr>
				        <th scope="row">@php echo $i=$i+1; @endphp</th>
						    ...
						    <td>{{($data->rank)}}</td> 
				        <td>
				        	<a href="{{URL::to('updatefieldcommittee/'.$data->id)}}"><img style="height: 35px; width: 35px; padding-right: 2px;" src="{{asset('frontendhome/images/view.PNG')}}"></a>
						    <a href="{{URL::to('deletefieldcommittee/'.$data->id)}}"><img style="height: 35px; width: 35px; padding-right: 2px;" src="{{asset('adminCss/img/delete.PNG')}}"></a>
					    </td>
				    </tr>
				    @endforeach
				</tbody>
