...
@section("content")
    <div class="shop-detail-box-main">
        <div class="container">
			<div class="form-group">
				<center>
						<div class="col-lg-12 col-md-12 col-sm-12">
							<form class="form-group" action="{{URL::to('addreliefcommittees')}}" method="GET">
								@csrf
								<div class="row">
									<div class="col-md-10">
			...
			<center>
	            <h2>ত্রান বিষয়ক সাব-কমিটির সদস্য মন্ডলী</h2>
	        </center>
	        <br>
			...
			<div class="row col-lg-12 col-md-12">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<form class="form-inline form-group" action="{{URL::to('searchreliefcommittee')}}" method="GET">
						@csrf
			    ...
			    <tbody>
			    	@foreach($committees as $data)
			      	<tr>
						...
						<td>{{($data->rank)}}</td>  
				        <td>
				        	<a href="{{URL::to('updatereliefcommittee/'.$data->id)}}"><img style="height: 35px; width: 35px; padding-right: 2px;" src="{{asset('frontendhome/images/view.PNG')}}"></a>
						    <a href="{{URL::to('deletereliefcommittee/'.$data->id)}}"><img style="height: 35px; width: 35px; padding-right: 2px;" src="{{asset('adminCss/img/delete.PNG')}}"></a>
					    </td>
				    </tr>
				    @endforeach
				</tbody>
